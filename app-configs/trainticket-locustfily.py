...
stats.PERCENTILES_TO_REPORT = [0.0 , 0.25, 0.5, 0.66, 0.75, 0.8, 0.9, 0.95, 0.98, 0.99, 0.999, 0.9999, 1.0]
...
####工具
    ...
    def query_and_preserve_use(self):
        ...
        if high_speed:
            ...
            trip_ids = self.query_high_speed_ticket(place_pair=high_speed_place_pair, headers=headers, time=tomorrow)
            ...
            trip_ids = self.query_normal_ticket(place_pair=other_place_pair, headers=headers, time=tomorrow)
        ...
        print("Query_and_preserve_use_success")
